...
public class AdaptadorJugadores extends BaseAdapter {
    ...
    public AdaptadorJugadores(Context contexto, ArrayList<Datos> listaObjetos) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) { //Es el método que se ejecuta cuando se muestra en mi ListView cada item
        ...
        vista=inflate.inflate(R.layout.itemlistview_jugadores, null); //Consigo referenciar a la vista en sí
