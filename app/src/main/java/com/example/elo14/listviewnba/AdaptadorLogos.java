...
/**
 * Created by elo14 on 18/11/2017.
 */

public class AdaptadorLogos extends BaseAdapter {
    ...
    public AdaptadorLogos(Context contexto, ArrayList<Datos> listaObjetos) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) { //Es el método que se ejecuta cuando se muestra en mi ListView cada item
        ...
        vista=inflate.inflate(R.layout.itemlistview_logos, null); //Consigo referenciar a la vista en sí

        ImageView imagenLogo=(ImageView)vista.findViewById(R.id.imgvEquipo);
        TextView nombre=(TextView)vista.findViewById(R.id.tvEquipo);


        nombre.setText(ListaObjetos.get(i).getNombreEquipo());
